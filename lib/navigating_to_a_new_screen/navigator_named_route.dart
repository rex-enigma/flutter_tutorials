...
// at line 103, used named routing mechanism from navigator api

class First_Route extends StatelessWidget {
  static const routeName = '/';
  First_Route({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pushNamed(context, Second_Route.routeName);
            },
...
class Second_Route extends StatelessWidget {
  ...
  const Second_Route({Key? key}) : super(key: key);
